...
namespace Boku.Common
{
    ...
    public static class Unicode
    {
        ...
        public static void Init()
        {
            ...
            string[] mirrorData = Storage4.ReadAllLines(Path.Combine("Xml", "Unicode", "BidiMirroring.txt"), StorageSource.TitleSpace);
            ...
            string[] unicodeData = Storage4.ReadAllLines(Path.Combine("Xml", "Unicode", "UnicodeData.txt"), StorageSource.TitleSpace);
